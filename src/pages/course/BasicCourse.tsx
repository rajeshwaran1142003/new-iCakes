        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-20 lg:py-24 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 items-center">
          <div>
            ...
            <AnimatedElement animation="fade-up" delay={200}>
              <h1 className="mt-3 sm:mt-4 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight">Basic Baking Class</h1>
            </AnimatedElement>
            ...
            <div className="mt-4 sm:mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              <AnimatedElement animation="fade-right" delay={350}>
                <div className="flex items-center space-x-2 bg-white rounded-xl px-3 py-2 shadow-sm border border-gray-200 hover:scale-105 transition-transform">
          ...
          <AnimatedElement animation="zoom-in" delay={200}>
            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl transform transition-transform duration-500 hover:-translate-y-1 hover:scale-105">
              <img src={assetPath('/img/design(4).png?v=2')} alt="Basic Baking" className="w-full h-[240px] sm:h-[280px] md:h-[360px] lg:h-[420px] object-cover" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 font-serif auto-rows-fr">
              ...
              <AnimatedElement animation="fade-up" delay={300}>
                <div className="bg-white rounded-2xl border border-gray-200 p-4 md:p-6 md:col-span-2 shadow-sm hover:shadow-md hover:scale-105 transition-all h-full flex flex-col">
          ...
          <AnimatedElement animation="fade-left" delay={200}>
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm sticky top-24 hover:shadow-lg transition-shadow">
